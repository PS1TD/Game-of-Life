...
export default function Dashboard() {
	...
	return (
		<div className="fixed bottom-0 w-full pointer-events-none">
			<div className="flex justify-around mb-16 text-xl font-semibold text-gray-800">
				<button
					onClick={() => {
						toggleRunning()
						if (!running) {
					...
					className={` ${running ? "bg-yellow-400" : "bg-green-400"} focus:outline-none p-4 rounded-full pointer-events-auto`}
				>
					{running ? (
				...
				<div className="flex space-x-8">
					<button onClick={() => clearGrid()} className=" bg-red-400 focus:outline-none p-4 rounded-full pointer-events-auto">
						<div className="flex flex-row justify-center items-center">
							<svg className=" h10 w-10 fill-current " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48px">
				...
				<div className="flex space-x-8">
					...
					<button className=" bg-indigo-400 focus:outline-none p-4 rounded-full pointer-events-auto">
						<div className="flex flex-row justify-center items-center">
							<svg className=" h10 w-10 fill-current " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48px">
								<rect fill="none" height="24" width="24" />
